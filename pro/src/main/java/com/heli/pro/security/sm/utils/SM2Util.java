...
import com.heli.pro.security.sm.base.SM2;
...
public class SM2Util {
    ...
    public static void generateKeyPair(){
        ...
        System.out.println("公钥: " + SMUtil.byteToHex(publicKey.getEncoded()));
        System.out.println("私钥: " + SMUtil.byteToHex(privateKey.toByteArray()));
    }
...
//      System.out.println("C3 " + Util.byteToHex(c3));
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        String cipherText = SM2Util.encrypt(SMUtil.hexToByte(pubk), sourceData);
        System.out.println(cipherText);
        System.out.println("解密: ");
        plainText = new String(SM2Util.decrypt(SMUtil.hexToByte(prik), SMUtil.hexToByte(cipherText)));
